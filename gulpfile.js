...
var templates = [
  path.join(sourceDirectory, '/inspirehep-js/**/templates/**/*.html')
];
...
gulp.task('build.src', function() {
  gulp.src(sourceFiles)
    ...
    .pipe(plugins.concat('inspirehep.js'))
    .pipe(gulp.dest('./dist/'))
    .pipe(plugins.uglify())
    .pipe(plugins.rename('inspirehep.min.js'))
...
gulp.task('build.templates', function() {
  gulp.src(templates, {cwd: sourceDirectory + 'inspirehep-js'})
